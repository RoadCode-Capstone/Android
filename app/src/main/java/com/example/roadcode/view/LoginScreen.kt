        ...
        Box(
            ...
            Column(
                ...
                Image(
                    ...
                    painter = painterResource(id = R.drawable.roadcode_name_image),
...
fun LoginCard(navController: NavController, loginUiState: LoginUiState, loginViewModel: LoginViewModel) {
    Card(
        ...
        Column(
            ...
            EmailInputBar(
                name = "이메일",
                data = loginUiState.email,
                onValueChange = { loginViewModel.updateInput(LoginField.EMAIL, it) }
            )

            PasswordInputBar(
                name = "비밀번호",
                data = loginUiState.password,
                onValueChange = { loginViewModel.updateInput(LoginField.PASSWORD, it) }
            )
